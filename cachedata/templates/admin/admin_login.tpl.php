...
<body>
	...
	<td width="8%" height="22">[<a href="./" target=_blank>前台首页</a>]</td>
	<td width="51%" ><hr></td>
...
<table width="372" height="76" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class=out_black>
	<tr class="header">
		<td height="100" colspan="2" align="center" ><font size="+3">管理员登录</font></td>
	</tr>
	<tr>
		<td width="33%" height="26" bgcolor="#FFFFFF"><font size="+2">用户名:</font></td>
		<td bgcolor="#FFFFFF"><input name="username" type="text" class="txt_input" tabindex="1" size="25" maxlength="40" style="width:200px;"></td>
	</tr>
	<tr>
		<td bgcolor="#FFFFFF"><font size="+2">密 码:</font></td>
	...
	<tr>
	  <td colspan="2" bgcolor="#FFFFFF">
	  	<center><input type="submit" name="loginsubmit" value="登录" style="cursor:pointer;" class="button" onClick="if(login.username.value=='' || login.password.value==''){alert('请输入用户名或者密码.');return false;}"/></center>
